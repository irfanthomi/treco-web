...
<div class="right_col" role="main">
    <div class="">
        ...
        <div class="col-md-6 col-sm-6  ">
            <div class="x_panel">
                <div class="x_title">
                    <button type="button" class="btn bg-defauld btn-sm" data-toggle="modal" data-target="#add_kategori">Tambah Kategori</button>
                            ...
                            <tbody>
                                ...
                                foreach ($kategori->result() as $kat) : ?>
                                    <tr class="even pointer">
                                        ...
                                        <td class="text-center last p-1"><a title="Edit" data-toggle="modal" data-target="#edit_kategori<?= $kat->id_kategori; ?>" class="btn text-light bg-defauld btn-sm"><i class="fa fa-edit"></i></a></td>
                                        <td class="text-center last p-1"><a href="<?= base_url('admin/kategori_hapus/'.$kat->id_kategori); ?>" title="Hapus" class="btn text-light bg-danger btn-sm"><i class="fa fa-trash"></i></a></td>
                    ...
                    <div class="modal-body">
                        <div class="x_content">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="kategori" value="<?= $katModal->kategori; ?>" required class="form-control ">
                                </div>
                            </div>
