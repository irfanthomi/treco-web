                    ...
                    <div class="x_content">
                        <form action="" method="POST" class="form-horizontal form-label-left"
                            ...
                            <div class="item form-group">
                                <label class="col-form-label  col-md-2 label-align" for="first-name">Judul <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-10 ">
                                    <input type="text" name="judul" value="<?= $judul_artikel ?>" required="required"
                                        class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-10 ">
                                    <input type="file" name="gambar" <?= ($gambar) ? "" : "required='required"; ?>
                                        value="<?= base_url('rn/gambar/' . $gambar) ?>">
