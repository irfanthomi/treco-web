...
(function () {
  ...
  $(document).ready(function () {
    ...
    $(".lightbox").click(function () {
      ...
      $("body").append(
        "<div class='img-popup'><img class='gbr' src='" +
        imgsrc + "'></div>");
  ...
  $(document).on('change', '.category', function () {
    ...
    load_data(selectedCategory)
  });


  $("#product_items").load("home/product_items", function () {
